...
const Page = async (props: { searchParams?: Promise<SearchParams> }) => {
  ...
  const filteredBooks = searchQuery
    ? allBooks.filter((book: bookInterface) => book.title.toLowerCase().includes(searchQuery.toLowerCase()))
    : allBooks
        ...
        <section className="relative py-8 md:py-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mb-8 text-gray-400">Search our collection of books and discover your next favorite story</p>
            ...
            <Suspense fallback={<BookListSkeleton />}>
              {paginatedBooks.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center rounded-xl bg-gray-800/50 py-16 px-4 text-center backdrop-blur-sm">
                  ...
                  <h2 className="mb-2 text-xl font-medium text-gray-300">No books found</h2>
